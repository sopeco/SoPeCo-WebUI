 ...
 * 
 */
public class ExecuteControllerOld implements ICenterController, ClickHandler {

	private ExecuteViewOld view;
	private boolean running = false;

	public ExecuteControllerOld() {
		reset();
	}
